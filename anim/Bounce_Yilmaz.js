class Bounce_Yilmaz extends Animator  {
    constructor() {
		...
		let y0 = "translateY(0px)", y1 = "translateY(500px)", y2 = "translateY(250px)", y3 = "translateY(500px)", y4 = "translateY(375px)", y5 = "translateY(500px)", y6 = "translateY(440)", y7 = "translateY(500px)";
